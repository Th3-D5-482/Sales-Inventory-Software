...
Public Class Phones
    ...
    Private Sub btnAdd_Click(sender As Object, e As EventArgs) Handles btnAdd.Click
        If (IsFormValid()) Then
            qry = "Insert into Phones values ('" & TextBox6.Text & "','" & ComboBox1.Text & "','" & TextBox3.Text & "','" & TextBox5.Text & "')"
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        If (IsFormValid()) Then
            qry = "Update Phones set ProID ='" & TextBox6.Text & "',ProCat ='" & ComboBox1.Text & "' ,ProName ='" & TextBox3.Text & "' ,ProQuantity ='" & TextBox5.Text & "'where ProID ='" & Convert.ToInt32(TextBox6.Text) & "'"
    ...
    Private Sub btnSearch_Click(sender As Object, e As EventArgs) Handles btnSearch.Click
        ...
        If count > 0 Then
            ...
            Dim sql As String = "Select ProID,ProCat,ProName,ProQuantity from Phones where ProID ='" & Convert.ToInt32(TextBox1.Text) & "'"
    ...
    Private Sub Phones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ComboBox1.Text = "Phones"
        TextBox6.Text = "10"
        BindGD()
    End Sub
                    ...
                    Else
                        If executed = False Then
                            ...
                            If Result = DialogResult.Yes Then
                                ...
                                MsgBox("Please Enter the Purchase Detais", MsgBoxStyle.Information)
                                f.TextBox3.Text = ak
                            Else
                                MsgBox("Product ID is Required", MsgBoxStyle.Critical)
                            End If
    ...
    Private Sub TextBox1_Leave(sender As Object, e As EventArgs) Handles TextBox1.Leave
        ...
        If r1.Length >= 2 Then
            ...
            End If
        Else
            MsgBox("Product ID is Required", MsgBoxStyle.Information)
            TextBox1.Clear()
        End If
    End Sub
